...
TEST_DIR=$1
CAT_DIR=$2
TEST_FILE="$TEST_DIR/bytes.txt"
CAT="$CAT_DIR/my_cat"
echo "" >>log.txt

for var in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
    TEST1="$var $TEST_FILE"
    echo "$TEST1"
...
for var in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
    for var2 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
        if [ $var != $var2 ]; then
...
for var in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
    for var2 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
        for var3 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
...
for var in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
    for var2 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
        for var3 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
            for var4 in -b -e -n -s -t -v -E -T --number-nonblank --number --squeeze-blank; do
